...
function enqueue_logged_in_assets(){
	wp_enqueue_style( 'logged-in-styles', get_stylesheet_directory_uri() . '/assets/index.css', array('astra-theme-css', 'nicole-hunn-members-global-css'), CHILD_THEME_NICOLE_HUNN_MEMBERS_VERSION, 'all' );
