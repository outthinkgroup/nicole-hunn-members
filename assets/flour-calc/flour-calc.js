...
},{"./bundle-url":"../node_modules/parcel/src/builtins/bundle-url.js"}],"flour-calc/src/components/Modal.svelte":[function(require,module,exports) {
"use strict";
...
function add_css() {
  ...
  style.id = "svelte-2mvl2p-style";
  style.textContent = ".modal.svelte-2mvl2p{position:absolute;left:calc(100% + 50px);bottom:60%;background:#fff;box-shadow:0 50px 100px rgba(50, 50, 93, 0.1),\n      0 15px 35px rgba(50, 50, 93, 0.15), 0 5px 15px rgba(0, 0, 0, 0.1);height:500px;width:300px;z-index:1;border-radius:8px;padding:20px}\n";
...
function create_fragment(ctx) {
  ...
  var block = {
    c: function create() {
      ...
      (0, _internal.attr_dev)(div, "class", "modal svelte-2mvl2p");
      (0, _internal.add_location)(div, file, 16, 0, 346);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
...
var Modal = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  function Modal(options) {
    ...
    _this = _super.call(this, options);
    if (!document.getElementById("svelte-2mvl2p-style")) add_css();
    (0, _internal.init)(_assertThisInitialized(_this), options, instance, create_fragment, _internal.safe_not_equal, {});
    (0, _internal.dispatch_dev)("SvelteRegisterComponent", {
      component: _assertThisInitialized(_this),
      tagName: "Modal",
