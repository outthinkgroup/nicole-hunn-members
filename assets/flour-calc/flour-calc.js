...
},{"./internal":"../node_modules/svelte/internal/index.mjs"}],"flour-calc/src/assests/icons/calculator.svelte":[function(require,module,exports) {
"use strict";
...
var activeRecipeSlug = (0, _store.writable)(allRecipeNames[0].slug);
exports.activeRecipeSlug = activeRecipeSlug;
var totalCups = (0, _store.writable)(1);
...
function create_if_block(ctx) {
  ...
  (0, _internal.dispatch_dev)("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(55:0) {#if isCalcShowing}",
    ctx: ctx
  });
  return block;
} // (56:2) <Modal on:close={toggleCalc}>
...
function create_default_slot(ctx) {
  ...
  (0, _internal.dispatch_dev)("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(56:2) <Modal on:close={toggleCalc}>",
    ctx: ctx
  });
  return block;
}
...
function create_fragment(ctx) {
  ...
  var block = {
    c: function create() {
      ...
      (0, _internal.add_location)(span0, file, 49, 2, 1351);
      (0, _internal.attr_dev)(span1, "class", "link-text");
      (0, _internal.add_location)(span1, file, 52, 2, 1406);
      (0, _internal.attr_dev)(button, "class", "nav-button nav-link svelte-17g4lul");
      (0, _internal.add_location)(button, file, 48, 0, 1290);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
...
function instance($$self, $$props, $$invalidate) {
  ...
  function showCalc(e) {
    ...
    _store.activeRecipeSlug.set(recipeSlug);
  ...
  (0, _svelte.onMount)(function () {
    var linkSelector = oldFlourCalcURL.map(function (obj) {
      return "a[href=\"".concat(obj.link, "\"]");
    }).join(", ");

    var allLinks = _toConsumableArray(document.querySelectorAll(linkSelector));
  ...
  (0, _svelte.onDestroy)(function () {
    var allLinks = _toConsumableArray(document.querySelectorAll());
...
var app = new _App.default({
  ...
  props: {
    ...
    oldFlourCalcURL: [{
      ...
      link: "https://glutenfreeonashoestring.com/d-i-y-gluten-free-all-purpose-flour/",
      type: "mockBetterBatter"
    }, {
      link: "https://glutenfreeonashoestring.com/basic-gluten-free-flour-blend/",
      type: "basicXanthanFreeBlend"
    }, {
      link: "https://glutenfreeonashoestring.com/better-than-cup4cup-gluten-free-flour-blend-d-i-y-how-to/",
      type: "betterThanCup4CupBlend"
    }, {
      link: "https://glutenfreeonashoestring.com/better-batter-pastry-flour-hack-mock-cup4cup/",
